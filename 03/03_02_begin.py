...
print(cosine_similarity(word_to_vector["dog"], word_to_vector["man"]))
print(cosine_similarity(word_to_vector["dog"], word_to_vector["plant"]))

# print(cosine_similarity(word_to_vector["dog"], word_to_vector["human"]))
